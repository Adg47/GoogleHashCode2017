...
def Placer_routeur():
    ...
    while ( fin == False and budget > 100*prix_routeur):
        ...
        if (budget - prix_routeur > 0) :
            ...
            if (cell != None):
                ...
                if (budget - cell.relier()[1] * prix_backbone >= prix_routeur):
...
##C:\Users\tiphaine\Documents\Polytech\3eme_annee_Info\projet_algo
