####### Fonctions pour tester mon code ########
def creation_cellules_Routeurs():
    cellule1= Cellule([0,1], '#', False)
    cellule2= Cellule([0,2], '-', False)
    cellule3= Cellule([0,3], '#', False)
    cellule4= Cellule([0,0], '-', False)

    cellule5= Cellule([1,0], '.', False)
    cellule6= Cellule([1,1], '#', False)
    cellule7= Cellule([1,2], '.', False)
    cellule8= Cellule([1,3], '-', False)
    
    cellule9= Cellule([2,0], '#', False)
    cellule10= Cellule([2,1], '#', False)
    cellule11= Cellule([2,2], '.', False)
    cellule12= Cellule([2,3], '#', False)

    routeur1 = Routeur(5,cellule1)
    routeur2 = Routeur(5,cellule3)
    routeur3 = Routeur(5,cellule6)
  

    liste_map = []
    liste_map.append(cellule1)
    liste_map.append(cellule2)
    liste_map.append(cellule3)
    liste_map.append(cellule4)
    liste_map.append(cellule5)
    liste_map.append(cellule6)
    liste_map.append(cellule7)
    liste_map.append(cellule8)
    liste_map.append(cellule9)
    liste_map.append(cellule10)
    liste_map.append(cellule11)
    liste_map.append(cellule12)

    liste_routeurs=[]
    liste_routeurs.append(routeur1)
    liste_routeurs.append(routeur2)
    liste_routeurs.append(routeur3)
 
    backbone=[]
    backbone.append(cellule1)
    backbone.append(cellule4)
    backbone.append(cellule2)
    backbone.append(cellule5)
    backbone.append(cellule6)
    backbone.append(cellule7)
    
    return liste_map, liste_routeurs, backbone
